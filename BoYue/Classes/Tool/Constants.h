...
// 小标题字体大小
#define kSubTitleFont       [UIFont systemFontOfSize:15]
// 小标题字体颜色
#define kSubTitleColor      [UIColor lightGrayColor]
...
#define kNaviBackColor     [UIColor colorWithRed:239/255.0 green:239/255.0 blue:239/255.0 alpha:1.0]
//通过RGB设置颜色
