...
- (NSURL *)detailVideoURLForRow:(NSInteger)row{
    return [NSURL URLWithString:[self modelForArr:self.indexPicArr row:row].murl];
}
...
- (BOOL)isVideoInIndexForRow:(NSInteger)row{
